...
custom_marker_genes_file <- here("inputs/custom_markers.tsv")
...
cluster_annotations_consensus %>% write_tsv(here("inputs/cluster_annotation.tsv"))
```
...
cluster_annotations_consensus <- read_tsv(here("inputs/cluster_annotation.tsv"))
