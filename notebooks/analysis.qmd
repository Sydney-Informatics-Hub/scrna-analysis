...
cluster_res_file <- "data/integrated_cluster_resolution.txt"
...
```{r plot_custom_cell_types}
DimPlot(
  integrated,
  reduction = "umap",
  group.by = c(cluster_name, "SingleR.hpca_main", "cell_type.max_score", "cell_type.mark_ambiguous"),
  label = TRUE,
  repel = TRUE,
  label.box = TRUE
)
