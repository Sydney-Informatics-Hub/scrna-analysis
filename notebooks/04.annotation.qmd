...
```{r print_cluster_assignments, message = FALSE, warning = FALSE, fig.heigh = 6}
...
```{r plot_custom_cell_types, echo = run_custom_annotation, eval = run_custom_annotation, message = FALSE, warning = FALSE, fig.width = 16, fig.heigh = 16}
...
```{r print_custom_cluster_assignments, message = FALSE, warning = FALSE, fig.heigh = 6}
integrated@meta.data %>%
...
```{r automatic_cluster_assignment, message = FALSE, warning = FALSE, fig.heigh = 6}
