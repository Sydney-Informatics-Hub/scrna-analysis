...
2. Update the contents of this file as necessary.
...
tibble(sample = names(total_cells), n_cells = total_cells) %>% datatable
```
...
datatable(cluster_filter_samplesheet)
```
...
datatable(cluster_res_samplesheet)
```
